...
internal class CRC 
{
    public static readonly int[] crc32Table = {
        unchecked(0x00000000), unchecked(0x04c11db7), unchecked(0x09823b6e), unchecked(0x0d4326d9),
        unchecked(0x130476dc), unchecked(0x17c56b6b), unchecked(0x1a864db2), unchecked(0x1e475005),
        unchecked(0x2608edb8), unchecked(0x22c9f00f), unchecked(0x2f8ad6d6), unchecked(0x2b4bcb61),
        unchecked(0x350c9b64), unchecked(0x31cd86d3), unchecked(0x3c8ea00a), unchecked(0x384fbdbd),
        unchecked(0x4c11db70), unchecked(0x48d0c6c7), unchecked(0x4593e01e), unchecked(0x4152fda9),
        unchecked(0x5f15adac), unchecked(0x5bd4b01b), unchecked(0x569796c2), unchecked(0x52568b75),
        unchecked(0x6a1936c8), unchecked(0x6ed82b7f), unchecked(0x639b0da6), unchecked(0x675a1011),
        unchecked(0x791d4014), unchecked(0x7ddc5da3), unchecked(0x709f7b7a), unchecked(0x745e66cd),
        ...
        unchecked(0x34867077), unchecked(0x30476dc0), unchecked(0x3d044b19), unchecked(0x39c556ae),
        unchecked(0x278206ab), unchecked(0x23431b1c), unchecked(0x2e003dc5), unchecked(0x2ac12072),
        unchecked(0x128e9dcf), unchecked(0x164f8078), unchecked(0x1b0ca6a1), unchecked(0x1fcdbb16),
        unchecked(0x018aeb13), unchecked(0x054bf6a4), unchecked(0x0808d07d), unchecked(0x0cc9cdca),
        unchecked(0x7897ab07), unchecked(0x7c56b6b0), unchecked(0x71159069), unchecked(0x75d48dde),
        unchecked(0x6b93dddb), unchecked(0x6f52c06c), unchecked(0x6211e6b5), unchecked(0x66d0fb02),
        unchecked(0x5e9f46bf), unchecked(0x5a5e5b08), unchecked(0x571d7dd1), unchecked(0x53dc6066),
        unchecked(0x4d9b3063), unchecked(0x495a2dd4), unchecked(0x44190b0d), unchecked(0x40d816ba),
        ...
        unchecked(0x690ce0ee), unchecked(0x6dcdfd59), unchecked(0x608edb80), unchecked(0x644fc637),
        unchecked(0x7a089632), unchecked(0x7ec98b85), unchecked(0x738aad5c), unchecked(0x774bb0eb),
        unchecked(0x4f040d56), unchecked(0x4bc510e1), unchecked(0x46863638), unchecked(0x42472b8f),
        unchecked(0x5c007b8a), unchecked(0x58c1663d), unchecked(0x558240e4), unchecked(0x51435d53),
        unchecked(0x251d3b9e), unchecked(0x21dc2629), unchecked(0x2c9f00f0), unchecked(0x285e1d47),
        unchecked(0x36194d42), unchecked(0x32d850f5), unchecked(0x3f9b762c), unchecked(0x3b5a6b9b),
        unchecked(0x0315d626), unchecked(0x07d4cb91), unchecked(0x0a97ed48), unchecked(0x0e56f0ff),
        unchecked(0x1011a0fa), unchecked(0x14d0bd4d), unchecked(0x19939b94), unchecked(0x1d528623),
        ...
        unchecked(0x5d8a9099), unchecked(0x594b8d2e), unchecked(0x5408abf7), unchecked(0x50c9b640),
        unchecked(0x4e8ee645), unchecked(0x4a4ffbf2), unchecked(0x470cdd2b), unchecked(0x43cdc09c),
        unchecked(0x7b827d21), unchecked(0x7f436096), unchecked(0x7200464f), unchecked(0x76c15bf8),
        unchecked(0x68860bfd), unchecked(0x6c47164a), unchecked(0x61043093), unchecked(0x65c52d24),
        unchecked(0x119b4be9), unchecked(0x155a565e), unchecked(0x18197087), unchecked(0x1cd86d30),
        unchecked(0x029f3d35), unchecked(0x065e2082), unchecked(0x0b1d065b), unchecked(0x0fdc1bec),
        unchecked(0x3793a651), unchecked(0x3352bbe6), unchecked(0x3e119d3f), unchecked(0x3ad08088),
        unchecked(0x2497d08d), unchecked(0x2056cd3a), unchecked(0x2d15ebe3), unchecked(0x29d4f654),
