...
namespace FlacLibSharp {
    ...
    public class CueSheetTrackIndex {
        ...
        public CueSheetTrackIndex(byte[] data, int dataOffset) {
            offset = BinaryDataHelper.GetUInt64(data, dataOffset);
            indexPointNumber = (byte)BinaryDataHelper.GetUInt64(data, dataOffset + 8, 8);
        }
        ...
        {
            targetStream.Write(BinaryDataHelper.GetBytesUInt64(offset), 0, 8);
            targetStream.WriteByte(indexPointNumber);
        ...
        public byte IndexPointNumber {
            get { return indexPointNumber; }
            set { indexPointNumber = value; }
        }	
