...
public interface IBeatmaniaService
{
    ...
    /// </summary>
    List<Chart> ReadPcChartsForGold(Stream stream) =>
    ...
    /// </summary>
    List<Chart> ReadPcChartsAfterGold(Stream stream) =>
        ReadPcCharts(stream, 1000d);

    /// <summary>
    /// Read sounds from a .2DX file.
    /// </summary>
    List<Sound> ReadPcSounds(Stream stream);
