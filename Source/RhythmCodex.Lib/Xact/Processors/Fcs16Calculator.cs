...
namespace RhythmCodex.Xact.Processors
{
    ...
    public class Fcs16Calculator : IFcs16Calculator
    {
        ...
        private static readonly Lazy<ushort[]> FcsTab = new Lazy<ushort[]>(() => new ushort[]
        {
        ...
        private const int PppInitFcs16 = 0xFFFF;

        public short Calculate(ReadOnlySpan<byte> data)
        {
