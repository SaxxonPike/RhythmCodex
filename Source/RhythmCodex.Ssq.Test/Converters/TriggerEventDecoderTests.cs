...
namespace RhythmCodex.Ssq.Converters
{
    ...
    public class TriggerEventDecoderTests : BaseUnitTestFixture<TriggerEventDecoder>
    {
        ...
        public void Decode_ConvertsTriggersCorrectly()
        {
            ...
            var expected = new[]
            {
                new Event {[NumericData.Trigger] = 0x2345, [NumericData.MetricOffset] = (BigRational)0x01020304 / 4096},
                new Event {[NumericData.Trigger] = 0x3456, [NumericData.MetricOffset] = (BigRational)0x02030405 / 4096},
