...
{
    [TestFixture]
    public class StepConverterTests : BaseTestFixture<StepConverter>
    {
        [Test]
        public void Convert_Steps_ConvertsRegularSteps()
        {
            // Arrange.
            var steps = new[]
            {
        ...
        [Test]
        public void Convert_Steps_ConvertsFreezeSteps()
        {
            // Arrange.
            var steps = new[]
            {
        ...
        [Test]
        public void Convert_Data_ConvertsRegularSteps()
        {
            // Arrange.
            var data = new byte[]
            {
        ...
        [Test]
        public void Convert_Data_ConvertsFreezeSteps()
        {
            // Arrange.
            var data = new byte[]
            {
