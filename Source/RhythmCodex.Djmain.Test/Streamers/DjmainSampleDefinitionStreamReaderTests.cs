    ...
    public class DjmainSampleDefinitionStreamReaderTests : BaseUnitTestFixture<DjmainSampleInfoStreamReader>
    {
        ...
        public void Read_ShouldReadAllDefinitions()
        {
            ...
            using (var mem = new MemoryStream(data))
            {
                ...
                output[0].Should().Be(new KeyValuePair<int, IDjmainSampleInfo>(0, new DjmainSampleInfo
                {
                    Channel = 0x12,
                    Frequency = 0x5634,
                    ReverbVolume = 0x78,
                ...
                output[1].Should().Be(new KeyValuePair<int, IDjmainSampleInfo>(1, new DjmainSampleInfo
                {
                    Channel = 0x34,
                    Frequency = 0x7856,
                    ReverbVolume = 0x90,
